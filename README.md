...
**SavedVariables:** `EllesmereUICastBarExtrasDB`

**설정 페이지 (`/eui` → CastBar Extras):**
- 마스터 토글: CastBar Extras 전체 활성/비활성
- 개별 기능 토글: Spark, Latency(SafeZone), Smoothing, Channel Ticks, Empowered Pip Styling
- 모든 토글은 `/reload` 없이 즉시 적용
...
| 날짜 | 내용 |
|------|------|
| 2026-03-08 | EllesmereUICastBarExtras에 /eui 설정 페이지 추가 — 마스터 토글 + 개별 기능 토글 (Spark, Latency, Smoothing, Channel Ticks, Empowered Pips), 리로드 없이 즉시 적용 |
